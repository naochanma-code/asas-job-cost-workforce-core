...
เวอร์ชัน M0-R4-2026-09-21 · ข้อมูลสมมติเท่านั้น · Owner ยืนยันPASSทั้ง7งานในtaskนี้ ดู M0_ACCEPTANCE
...
| U-05 ตรวจรายการ | Adminแก้จำนวน/รายละเอียด/เงิน/รูปexpenseพร้อมเหตุผล แล้วอนุมัติเวลาและexpense; ทดลองOwnerทั้ง3บัญชี | Adminเห็นexpenseรายรายการ แต่ไม่มีต้นทุนรวม/ค่าแรง; PMเห็นเฉพาะexpenseของตน; Ownerเห็นActualจากapprovedและactorถูกต้อง | before/after/role/actor |
...
เพิ่มเติมรอบ2: ลงเช้าA/บ่ายBให้รวม1วัน; ลองลงช่วงเช้าซ้ำต้องไม่ผ่าน; Adminไม่เห็นยอดรวมต้นทุน/ค่าแรง แต่แก้เงินและรูปexpenseรายรายการได้; PMไม่เห็นเงินผู้อื่นหรือยอดรวม; เปลี่ยนOwner1/2/3แล้วตรวจactor; รูปแนบผิดชนิด/เกิน5/เกิน10MBไม่ผ่าน; เปลี่ยนเดือนต้องไม่ส่งไฟล์ผิดเดือน
...
| --- | --- | --- | --- | --- | --- |
| M0 U-01–U-07 | local prototype R4 | PASS ตามคำยืนยัน Owner | ไม่มีบันทึกจำนวนครั้งจากการสังเกต | [ผลรายงาน](M0_ACCEPTANCE.md) | Owner / 2026-09-21 |
...
ทดสอบPM(B)/Admin/OwnerลงWorkและOTแทนT2 แสดงemployeeและsubmitted_byต่างกัน TECHเลือกแทนไม่ได้ ทุกroleส่งexpenseได้; เลือกLINEแล้วต้องPENDING_REVIEWไม่มีActual/ZIPจนAdminหรือOwnerกดapprove รวมผู้ส่งAdmin/Owner PMเห็นเฉพาะexpenseตนเองไม่เห็นของTECH; Owner AcceptanceแยกจากCodex walkthrough ใน [M0_ACCEPTANCE](M0_ACCEPTANCE.md)
