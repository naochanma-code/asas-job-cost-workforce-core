...
| Customer, optional Site, Project, optional Job, configurable types | Admin สร้าง Customer/Project ไม่มี Site/Job และอีก Project ที่มี Site/Job ผ่าน Web Staging; Owner ยืนยันสร้าง Job ผ่านหลังแก้ UI; type/Job/Project API และ PostgreSQL regression ผ่าน | Web UAT เฉพาะรายการสมมติที่บันทึก; โครงการจริง `PRJ-3511fa71` ยังไม่ยืนยันสาเหตุการกดสร้าง Job ครั้งแรก |
