...
| Browser recovery | encrypted isolated recoveryเดิม และNative/API restore regression | BrowserLoginหลังrestore, Sessionเก่าถูกปฏิเสธ, scope/logoutผ่าน | ทำตามM1_BROWSER_RECOVERY_CHECKLIST; localไม่แทนprovider |
