...
ให้แต่ละคนส่งคำสั่งของตนหา OA ในแชทส่วนตัว (คนละรหัส) จากนั้นให้หนึ่งในผู้ลงทะเบียนส่งรหัสกลุ่มในกลุ่มทดสอบที่มี OA อยู่ กดตรวจผลลงทะเบียนบนเว็บจนได้รับครบ3คน/1กลุ่ม ไม่ต้องส่งรหัสเหล่านี้ในแชทกับ Codex
