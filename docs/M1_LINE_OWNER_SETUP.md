...
สถานะล่าสุด: ข้อ1และข้อ2ผ่านแล้ว — ลงทะเบียนครบ3คน/1กลุ่มและเก็บขอบเขตในRailwayแล้ว ไม่ต้องส่งรหัสซ้ำหรือกรอกค่าลับใหม่ ยังไม่เปิดข้อ3จนกว่าCodexตรวจworker/สิทธิ์โครงการสมมติและsecuritygatesผ่าน. ขั้นตอนข้อ2ด้านล่างเก็บไว้สำหรับรอบใหม่เท่านั้น
