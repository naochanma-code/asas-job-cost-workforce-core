...
หลักฐาน Admin สร้าง Project A ไม่มี Site/Job มอบหมาย TECH และสร้าง Job ใน B บน Web Staging (23 ก.ย.) กับ TECH เห็น PILOT LINE A ไม่มี Site/Job ใน LINE จริง (25 ก.ย.) ใช้ **คนละ fixture**. จึงยืนยันความสามารถแต่ละส่วนได้ แต่ยังไม่อ้าง flow Admin-create/assign → TECH-LINE ใน Project เดียวจากหลักฐานที่มี. ก่อนขอทดสอบซ้ำ ให้ตรวจ audit/creator/assignment ของ Project Pilot ที่อนุมัติแบบอ่านอย่างเดียวว่าพิสูจน์ความเชื่อมโยงได้หรือไม่; หากไม่ได้ ให้ระบุข้อจำกัดในรายงานรับ M1 และเสนอขั้นทดสอบเพิ่มเติมภายใน scope ที่ Owner อนุมัติ ไม่เพิ่ม Project allowlist เอง.
