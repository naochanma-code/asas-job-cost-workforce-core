...
- Admin/PM เห็นเฉพาะคน วันเข้างาน จำนวนวันทำงานและชั่วโมง OT ไม่เห็นยอดเงินทุกประเภทหรือรูปบิล/สลิป; Admin ตรวจเวลาได้ ส่วน Owner ตรวจยอด/อนุมัติค่าใช้จ่ายและตั้งงบ (MASTER v2.3 / ADR-007)
